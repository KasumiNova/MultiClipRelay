...
pub fn t(lang: Lang, k: K) -> &'static str {
    match (lang, k) {
        ...
        (Lang::ZhCn, K::TabActivity) => "历史/日志",
        (Lang::En, K::TabActivity) => "History/Logs",
        (Lang::ZhCn, K::TabHelp) => "说明",
        (Lang::En, K::TabHelp) => "Help",

        (Lang::ZhCn, K::SubTabHistory) => "同步历史",
        (Lang::En, K::SubTabHistory) => "Sync history",
        (Lang::ZhCn, K::SubTabAppLogs) => "程序日志",
        (Lang::En, K::SubTabAppLogs) => "App logs",
        (Lang::ZhCn, K::SubTabClipboardLogs) => "系统剪贴板日志",
        (Lang::En, K::SubTabClipboardLogs) => "System clipboard logs",
        ...
        (Lang::ZhCn, K::LabelDebugMode) => "调试模式",
        (Lang::En, K::LabelDebugMode) => "Debug mode",
        (Lang::ZhCn, K::LabelDebugEnable) => "启用详细日志",
        (Lang::En, K::LabelDebugEnable) => "Enable verbose logs",
